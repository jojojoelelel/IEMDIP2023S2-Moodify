...
import { pxToDp } from '/Users/sneha.m7/Moodify/utils/stylesKits.js';
...
const PIscreen = () => {
  ...
  return (
    <ImageBackground source={require('/Users/sneha.m7/Moodify/assets/images/background.png')} style={{ flex: 1 }}>
        ...
        source={require('/Users/sneha.m7/Moodify/assets/icon/backbtn.png')} // Replace 'path_to_your_image.png' with the actual path to your image
        style={{ width: 50, height: 50 }} // Adjust the width and height according to your preference
      /></TouchableOpacity>
        <Image source={require('/Users/sneha.m7/Moodify/assets/icon/profile.jpg')} style={styles.profileImage} />
        <FlatList
          data={userData}
