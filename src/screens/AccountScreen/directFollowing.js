  ...
  return (
    <View style={styles.header}>
      ...
      <View style={styles.headerTextContainer}>
        ...
        <Text style={colorTheme === 'Dark' ? styles.headerTextDark : styles.headerTextLight}>People you are following {'\n'}</Text>
      </View>
      
      <Text style={colorTheme === 'Dark' ? styles.fNumTextDark : styles.fNumTextLight}>{followingCount}</Text>
    </View>
  );
};
